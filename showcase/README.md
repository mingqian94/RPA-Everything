...
| `web/xhs/user_posts` | 慢滚动采集某个小红书用户主页的帖子卡片 | 否 | `python run.py showcase/web/xhs/user_posts -- --user-url <URL>` |
| `web/xhs/search_posts` | 慢滚动采集某个搜索词或 tag 下的帖子卡片 | 否 | `python run.py showcase/web/xhs/search_posts -- --keyword "露营"` |
| `web/xhs/post_detail` | 采集单篇帖子内可见文字、图片、视频和互动信息 | 否 | `python run.py showcase/web/xhs/post_detail -- --url <URL>` |
