...
```bash
python run.py showcase/mobile/iphone_assist/iphone_assist -- --devices
python run.py showcase/mobile/iphone_assist/iphone_assist -- --diagnostics
python run.py showcase/mobile/iphone_assist/iphone_assist -- --copy-text "Draft text" --launch-wechat
```
