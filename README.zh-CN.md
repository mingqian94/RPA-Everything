...
| `showcase/android/xhs_note` | Android ADB App 流程 | ✅ 可运行 | 慢节奏起草小红书笔记；默认停在最终发布前；`--profile data/xhs_profile.json --dry-run` |
| `showcase/ios/iphone_assist` | iPhone 半自动 | ✅ 可运行 | 可选依赖 `pymobiledevice3`；复制文案、打开 App、截图留证，最终操作人工确认 |
